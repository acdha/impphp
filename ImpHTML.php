<?php
	class ImpHTML {
		...
		public static function generateSelectFromArray($the_array, $select_name, $selected_value = false, $use_value_as_key = false) {
			/*
		...
		public static function getTimeFromSelectArray($Fields) {
			/**
		...
		public static function generateHiddenInputs($source) {
